			...
			<div className="m-0" style={{ backgroundColor: '#0088cc', overflow: "hidden" }}>
				<div className="row d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
					<Form
						...
						<h4 className='text-center text-capitalize text-warning mb-4' style={{ paddingLeft: '150px' }}>Register Now</h4>
						<Form.Item
						...
						<Form.Item wrapperCol={{ offset: 8, span: 16 }}>
							<Button type="primary" onClick={handleSubmit} style={{ marginLeft: '120px' }}>Register Now</Button>
						</Form.Item>
					</Form>
				</div>
			</div >
